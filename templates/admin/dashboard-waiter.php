<?php
/**
 * Orders Jet - Waiter Dashboard Template
 * This template renders the React dashboard for waiters
 */
...
<div class="wrap">
    <div id="orders-jet-waiter-dashboard">
        <!-- Loading fallback -->
        <div class="loading" id="dashboard-loading">
            <div class="loading-spinner"></div>
            <p><?php _e('Loading waiter dashboard...', 'orders-jet'); ?></p>
        </div>
    </div>
</div>
...
#orders-jet-waiter-dashboard {
    margin: -20px -20px 0 -20px;
}

#orders-jet-waiter-dashboard .dashboard-container {
    min-height: calc(100vh - 32px);
}

/* WordPress admin bar adjustment */
body.admin-bar #orders-jet-waiter-dashboard .header {
    top: 32px;
}

body.admin-bar #orders-jet-waiter-dashboard .main-content {
    margin-top: 92px;
}
</style>
